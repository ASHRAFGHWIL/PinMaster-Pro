...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F9F9F9] dark:bg-dark-bg flex flex-col md:flex-row text-start transition-colors duration-300" dir={dir}>
      <Sidebar 
        activeTab={activeTab} 
      ...
      <main className="flex-1 flex flex-col h-screen overflow-hidden">
        ...
        <header className="md:hidden bg-white dark:bg-dark-card p-4 shadow-sm flex items-center justify-between z-10 border-b border-gray-100 dark:border-dark-border">
           <h1 className="font-bold text-lg text-gray-800 dark:text-white">{t.appTitle}</h1>
